...
describe("CaseObj", () => {
  ...
  test("should handle an array of objects and convert only the keys", () => {
    const inputArray = [{ user_name: "Alice" }, { user_name: "Bob" }];

    const expectedOutput = [{ userName: "Alice" }, { userName: "Bob" }];
  ...
  it("should convert obj key to dot case", () => {
    const inputArray = [{ user_name: "Alice" }, { "user name": "Bob" }];
    const expectedOutput = [{ "user.name": "Alice" }, { "user.name": "Bob" }];
  ...
  it("should convert obj key to pascal case", () => {
    const inputArray = [{ "user name": "Alice" }, { user_name: "Bob" }];
    const expectedOutput = [{ UserName: "Alice" }, { UserName: "Bob" }];
  ...
  it("should convert obj key to sentence case", () => {
    const inputArray = [{ "user name": "Alice" }, { user_name: "Bob" }];
    const expectedOutput = [{ "User name": "Alice" }, { User_name: "Bob" }];
  ...
  it("should convert obj key to snake case", () => {
    const inputArray = [{ "user name": "Alice" }, { user_name: "Bob" }];
    const expectedOutput = [{ user_name: "Alice" }, { user_name: "Bob" }];
  ...
  it("should convert obj key to kebab case", () => {
    const inputArray = [{ "user name": "Alice" }, { "user name": "Bob" }];
    const expectedOutput = [{ "user-name": "Alice" }, { "user-name": "Bob" }];
    expect(CaseObj.objToKebab(inputArray)).toEqual(expectedOutput);
    expect(objToKebab(inputArray)).toEqual(expectedOutput);
  });
